...
public class ViewPagerCategoryAdapter extends FragmentPagerAdapter {
    public static final String EXTRA_DATA_NAME = "nameCAT";
    public static final String EXTRA_DATA_DESC = "descCAT";
    public static final String EXTRA_DATA_IMAGE = "imageCAT";
